...
/*
* game test with correct answer
*/




public class CorrectAnswers extends DriverManager {
    ...
    public void gamePlayScreen1()  {
        ...
        gamePlayAnswerScreen[0].clickOnRadioButton("3","4");
    ...
    public void gamePlayScreen3()  {
        ...
        gamePlayAnswerScreen[2].clickOnRadioButton("1","2");
